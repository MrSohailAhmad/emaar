            ...
            <div className="content">
                <div className="left-panel">
                    ...
                    <div className="actions">
                        <button
                            className="bg-red-600 text-white w-[50%] px-6 py-3 lg:w-auto buttonAnimation my-2"
                        >
                            Get All Floor Plans.pdf
                        </button>
                        <button
                            className="bg-red-600 text-white w-[50%] px-6 py-3 lg:w-auto buttonAnimation my-4"
                        >
